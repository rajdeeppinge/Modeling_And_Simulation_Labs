...
title(['Variation in temperature at corner and midpoint w.r.t time,  TempBar = ' num2str(AMBIENT) ' deg Celcius, TempExtSrc = ' num2str(EXT_SRC) ' deg Celcius'])
xlabel('time (sec)')
