...
q_arr = [0 0.1 0.5 0.66 0.67 0.8] ; % frac of Sus moving to quarantine[either expo or quarantined]
...
title('Variation in recovered with varying q');
xlabel('time (days)', 'FontSize', 16)
%ylabel('Number of susceptible', 'FontSize', 16)
%ylabel('Number of total infected', 'FontSize', 16)
%ylabel('Number of deaths', 'FontSize', 16)
ylabel('Number of recovered', 'FontSize', 16)
legend('q=0', 'q=0.1', 'q=0.5', 'q=0.66', 'q=0.67', 'q=0.8');