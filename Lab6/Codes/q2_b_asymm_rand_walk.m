...
p = 0.7;    % probability of going right i.e. by convention positive direction
...
title(['Asymmetric Random Walk - Mean Displacement,  p = ' num2str(p)])
...
title(['Asymmetric Random Walk - Mean Sqaured Displacement,  p = ' num2str(p)])
xlabel('Number of steps in random walk', 'FontSize', 16)
