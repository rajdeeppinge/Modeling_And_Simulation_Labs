...
title(['Random Walk of varying lengths - Mean Displacement,  p=' num2str(p) ', mu=' num2str(mu) ', sigma=' num2str(sigma)])
...
title(['Random Walk of varying lengths - Mean Sqaured Displacement,  p=' num2str(p) ', mu=' num2str(mu) ', sigma=' num2str(sigma)])
xlabel('Number of steps in random walk', 'FontSize', 16)
